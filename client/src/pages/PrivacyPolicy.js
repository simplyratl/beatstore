...
import Illustration from '../assets/images/illustrations/undraw_two_factor_authentication_namy.svg';
import '../style/dist/privacypolicy.min.css';
            ...
            <div className='privacy-policy'>
                ...
                <div className='content'>
                    <div className='left'>
                        <ul>
                            <li
                                className='privacy-policy-ratlx'
                                onClick={() => {
                                    document
                    ...
                    <div className='right'>
                        <div id='section1' className='section'>
                            <h1>Privacy Policy for ratlx</h1>

                            <p>
                                At Beatstore Ratlx, accessible from www.beatstoreratl.com, one of our main
                                priorities is the privacy of our visitors. This Privacy Policy document
                                contains types of information that is collected and recorded by Beatstore
                                Ratlx and how we use it.
                            </p>
                            ...
                            <p>
                                ...
                                and/or collect in Beatstore Ratlx. This policy is not applicable to any
                        ...
                        <div id='section3' className='section'>
                            ...
                            <p>
                                Beatstore Ratlx follows a standard procedure of using log files. These files
                        ...
                        <div id='section4' className='section'>
                            ...
                            <p>
                                Like any other website, Beatstore Ratlx uses 'cookies'. These cookies are used
                        ...
                        <div id='section5' className='section'>
                            ...
                            <p>
                                ...
                                advertising partners of Beatstore Ratlx.
                            </p>

                            <p>
                                Third-party ad servers or ad networks uses technologies like cookies,
                                JavaScript, or Web Beacons that are used in their respective advertisements
                                and links that appear on Beatstore Ratlx, which are sent directly to users'
                            ...
                            <p>
                                Note that Beatstore Ratlx has no access to or control over these cookies that
                        ...
                        <div id='section6' className='section'>
                            ...
                            <p>
                                Beatstore Ratlx's Privacy Policy does not apply to other advertisers or
                        ...
                        <div id='section9' className='section'>
                            ...
                            <p>
                                Beatstore Ratlx does not knowingly collect any Personal Identifiable
